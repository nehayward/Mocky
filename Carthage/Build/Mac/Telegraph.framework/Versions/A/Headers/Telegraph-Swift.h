...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Telegraph",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9Telegraph11TCPListener")
...
@interface TCPListener (SWIFT_EXTENSION(Telegraph)) <GCDAsyncSocketDelegate>
...
SWIFT_CLASS("_TtC9Telegraph9TCPSocket")
...
@interface TCPSocket (SWIFT_EXTENSION(Telegraph)) <GCDAsyncSocketDelegate>
